...
nav: Reactivity & State
category: essentials
order: 2
description: Declare state with s-data, derive values with getters, and add behavior with methods. Summit tracks reads and updates only what changed.
---
