...
category: components
order: 0
description: An accessible, token-themed component library you copy into your markup and theme with CSS variables. Built with Summit, for people and AI agents.
---
